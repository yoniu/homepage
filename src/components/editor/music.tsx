...
export default function EditorMusic() {
  ...
  const handleChangeLrc = (e: React.ChangeEvent<HTMLInputElement>) => handleChange(e, 'lrc');
  ...
  return (
    <SidebarCollapse title="背景音乐" className="space-y-1">
      ...
      <Input placeholder="歌词链接 (可空)" value={state.attributes?.music?.lrc} onChange={handleChangeLrc} />
