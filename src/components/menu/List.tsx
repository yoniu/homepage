...
export default function List() {
  ...
  const className = (item: TNav) => {
    ...
    if (pathname === url)
      return "flex items-center bg-[#005DD9]/20 text-lg rounded-lg px-2 py-2 -mx-2 space-x-2 transition-all"
    else 
      return "flex items-center hover:bg-gray-300 text-lg rounded-lg px-2 py-2 -mx-2 space-x-2 transition-all"
  }
  ...
  const Admin = () => (
    <Link className="flex items-center hover:bg-gray-300 text-lg rounded px-3 py-2 -mx-3 space-x-2 transition-all" href="/admin">
      <GlobalOutlined />
  ...
  const Switch = () => (
    <button className="flex items-center hover:bg-gray-300 text-lg rounded px-3 py-2 -mx-3 space-x-2 transition-all" onClick={handleSwitch}>
      <TikTokOutlined />
